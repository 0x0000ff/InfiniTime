...
Notifications::NotificationItem::NotificationItem(const char* title,
  ...
  lv_obj_set_pos(container1, 0, 33);
  lv_obj_set_size(container1, LV_HOR_RES, 206);
  ...
  lv_obj_align(alert_count, NULL, LV_ALIGN_IN_TOP_RIGHT, 0, 10);
  ...
  lv_obj_align(alert_type, NULL, LV_ALIGN_IN_TOP_LEFT, 0, 10);
